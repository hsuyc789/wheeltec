...
# image processing
def image_processing(results, pub_conf):
...
# image data callback
def image_callback(msg, pub, pub_conf):
    # Get the input image 
...
def main():
    ...
    image_sub = node.create_subscription(Image,'/image_raw',lambda msg: image_callback(msg, pub,pub_conf), qos)
